...
export default function CreateProductView() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
        await addProduct({ nombre: nombre.value, precio: parseFloat(precio.value) });
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="p-fluid p-formgrid p-grid">
            ...
            <div className="p-field p-col-12">
            <label>Precio</label>
            <InputNumber name="precio" mode="currency" currency="ARS" locale="es-AR" required />
            </div>
            <Button type="submit" label="Crear" icon="pi pi-check" className="p-button-success" />
        </form>
        </div>
    );
}
